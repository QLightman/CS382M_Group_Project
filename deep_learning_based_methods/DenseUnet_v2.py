...
def dense_Unet_v2(input_shape=(512, 512, 1),
                  num_classes=1):
    ...
    up4_1=dense_block(up4,[[1,128],[3,128],[1,512]])
    up4_2=dense_block(up4_1,[[1,128],[3,128],[1,512]])
    up4_2_1=concatenate([up4_2, up4_1], axis=3)
    up4_3=dense_block(up4_2_1,[[1,128],[3,128],[1,512]])
    up4_3_2_1=concatenate([up4_3, up4_2_1], axis=3)
    up4=dense_block(up4_3_2_1,[[1,128],[3,128],[1,512]])
    ...
    up3_1=dense_block(up3,[[1,64],[3,64],[1,256]])
    up3_2=dense_block(up3_1,[[1,64],[3,64],[1,256]])
    up3_2_1=concatenate([up3_2, up3_1], axis=3)
    up3=dense_block(up3_2_1,[[1,64],[3,64],[1,256]])
...
saveResult("data/membrane/denseunet_v2_512_2_EPOCH30",results)
